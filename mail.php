...
$Referer_check_domain = "portfolio.ironedi.com";
...
$require = array('your-name','email','message');
...
$refrom_name = "uiconnect";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【自動返信】送信が完了しました";
...
内容を確認し、2日以内にご連絡いたしますのでしばらくお待ちください。
...
國安秀則
携帯：09049354908
E-mail：contact@ironedi.com
URL：portfolio.ironedi.com
──────────────────────
...
<input type="submit" value="　送信する　" class="confirm-button">
<input type="button" value="前画面に戻る" onClick="history.back()" class="confirm-button"></p>
</form>
<?php } ?>
</div><!-- /formWrap -->
<!-- ▲ *********** 送信内容確認部　※編集は自己責任で ************ ▲-->
